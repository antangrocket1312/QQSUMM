...
class Options:
    ...
    def add_modeling_options(self):
        ...
        self.parser.add_argument(
            "--train_with_rank_threshold",
            action="store_true",
            help="pass this to enable training the retriever using rank_threshold. By default, topk will be "
                 "dynamically selected as the amount of query-relevant comments found in the ground truth",
        )
        self.parser.add_argument(
            "--rank_threshold",
            type=float,
            # default=1.6, # NQ XXL
            # default=1.15,
            default=1, # BEST FOR TRAINING
            # default=1.3,
            help="Threshold for ranking",
        )
        self.parser.add_argument(
            "--max_retrieval",
            type=int,
            default=None,
            # default=100,
            help="Maximum number of comments to retrieve before rank_threshold",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            # default=1.2,  # BEST
            # default=1.3,  # BEST
            default=1.25,  # BEST FOR TRAINING
            # default=1,  # Over-counting
            # default=1.35,  # GOOD
            # default=1.65,
            help="Threshold for clustering greedy algorithm of retrieved passages to form opinion cluster",
        )
        self.parser.add_argument(
            "--mean_cluster_similarity_to_query_threshold",
            type=float,
            # default=1.9,  # NQ XXL
            # default=1.25,
            # default=1.15,  # BEST
            # default=1.3,  # GOOD
            default=1.3,  # BEST FOR TRAINING
            # default=1.1, # Over-counting
            # default=1.4,  # GOOD
            # default=1.7,
            help="Threshold of mean similarity of opinion cluster to query for post-filtering",
        )
        self.parser.add_argument(
            "--min_cluster_size",
            type=int,
            default=3,
            # default=5,
            help="Minimum size of cluster for post-filtering",
        )
        ...
        # Generation options
        self.parser.add_argument("--generation_max_length", type=int, default=4096)
