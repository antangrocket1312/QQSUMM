The code was cloned from the [repository](https://github.com/yuh-zha/AlignScore) of the paper "AlignScore: Evaluating Factual Consistency with a Unified Alignment Function"
